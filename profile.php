    ...
    <div class="profile-section">
        <div class="profile-info">
            ...
            <div class="profile-photo">
                ...
                <?php else : ?>
                    <img src="image.png" alt="Default Profile Photo" width="200" height="200">
                <?php endif; ?>
            </div>
            <form method="POST">
            ...
            <div class="lists-section">
                ...
                <div class="recommended-movies">
                    ...
                    <table>
                        <tr>
                            <td><a href="#">Movie 4</a></td>
                        </tr>
                        <tr>
                            <td><a href="#">Movie 5</a></td>
                        </tr>
                        <tr>
                            <td><a href="#">Movie 6</a></td>
                        </tr>
                        <tr>
                            <td><a href="#">Movie 7</a></td>
                        </tr>
                    </table>
                </div>
            </div>
